      ...
      <div class="d-flex">
        ...
        <div class="navbar-brand-box horizontal-logo">
          <a href="index.html" class="logo logo-dark">
            <span class="logo-sm">
              <img src="{{ asset('images/images/logo-sm.png') }}" alt="" height="22" />
            </span>
            <span class="logo-lg">
              <img src="{{ asset('images/images/logo-lg.png') }}" alt="" height="17" />
            </span>
          </a>
        ...
        <div class="dropdown ms-1 topbar-head-dropdown header-item">
          ...
          <div class="dropdown-menu dropdown-menu-end">
            ...
            <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="fr" title="French">
              <img src="{{ asset('images/flags/frech.svg') }}" alt="user-image" class="me-2 rounded" height="18" />
          ...
          <div class="dropdown-menu dropdown-menu-lg p-0 dropdown-menu-end">
            <div class="p-3 border-top-0 border-start-0 border-end-0 border-dashed border">
              <div class="row align-items-center">
                ...
                <div class="col-auto">
                  <a href="#!" class="btn btn-sm btn-soft-info shadow-none"> View All Apps <i
            ...
            <div class="tab-content position-relative" id="notificationItemsTabContent">
              <div class="tab-pane fade show active py-2 ps-2" id="all-noti-tab" role="tabpanel">
                <div data-simplebar style="max-height: 300px" class="pe-2">
                  ...
                  <div class="my-3 text-center view-all">
                    <button type="button" class="btn btn-soft-success waves-effect waves-light">View All Notifications
              ...
              <div class="notification-actions" id="notification-actions">
                <div class="d-flex text-muted justify-content-center">
                  ...
                  Result <button type="button" class="btn btn-link link-danger p-0 ms-3" data-bs-toggle="modal"
        ...
        <div class="dropdown ms-sm-3 header-item topbar-user">
          ...
          <div class="dropdown-menu dropdown-menu-end">
            ...
            <a class="dropdown-item" href="auth-lockscreen-basic.html"><i
                ...
                screen</span></a>
            <button class="dropdown-item" id="logout-button" href="auth-logout-basic.html"><i
